...
const Button = forwardRef(({
  ...
  const variantClasses = {
    ...
    info: "bg-transparent hover:bg-info-light active:bg-info-dark text-info-base hover:text-white active:text-white transform transition-transform hover:scale-105 active:scale-95",
