import { Info, Waypoints, Settings, Wrench, Speech, Sparkle, MessageCirclePlus, Send, Paperclip, ToolCase } from "lucide-react"
      ...
      <Paper className="relative bg-lightBg-primary dark:bg-darkBg-primary py-2 rounded-lg flex items-center gap-2 max-w-[95%] mb-2 mx-auto">
        <div className="w-full flex flex-col gap-2 md:hidden">
          <div className="flex items-center justify-between flex-wrap gap-2">
            ...
            <Button variant="secondary" size="icon" $rounded title="Construtor de Ferramentas" onClick={toggleToolBuilderDoor} disabled={loading || isImproving}><ToolCase size={16} /></Button>
