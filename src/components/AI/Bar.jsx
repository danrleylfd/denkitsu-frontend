...
const AIBar = ({ userPrompt, setUserPrompt, onAddImage, imageCount, onSendMessage, clearHistory, toggleSettings, loading }) => {
  ...
  return (
    <Paper className="relative bg-lightBg-primary dark:bg-darkBg-primary py-2 rounded-lg flex items-center gap-2 max-w-[95%] mb-2 mx-auto">
      ...
      {/* LINHA 2 (Mobile) / PARTE 1 (Desktop): BOTÕES DE AÇÃO */}
      <div className="flex w-full items-center justify-around sm:w-auto sm:justify-start gap-2 order-2 sm:order-1">
        {/* --- Botões que aparecem apenas no Desktop --- */}
        ...
        {/* --- Botão de Ouvir: aparece em todas as telas, mas está aqui para melhor posicionamento no mobile --- */}
