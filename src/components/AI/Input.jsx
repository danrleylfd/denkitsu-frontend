...
const AIInput = ({
  ...
  return (
    <div ref={containerRef} className="relative w-full">
      ...
      <textarea
        className={"flex-1 resize-none min-h-[1.25rem] max-h-[10rem] w-full overflow-y-auto p-2 rounded-md font-mono text-sm bg-lightBg-secondary dark:bg-darkBg-secondary text-lightFg-secondary dark:text-darkFg-secondary " + className}
        rows={rows}
        maxLength={maxLength}
