...
const TaskCard = ({ task, showControls = true }) => {
  ...
  if (isEditing) {
    return (
      <div ref={setNodeRef} style={style} className="bg-light-background dark:bg-dark-inputBg p-3 rounded-lg shadow-lg flex flex-col gap-2 ring-2 ring-primary-base">
        <input
          type="text"
          value={editedContent}
  ...
  return (
    <div ref={setNodeRef} style={style} className="bg-light-inputBg dark:bg-dark-inputBg p-3 rounded-lg shadow-sm text-sm flex items-center gap-2">
