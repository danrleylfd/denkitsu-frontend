    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-2 h-full">
      ...
      <div className="flex-grow overflow-y-auto pr-2 flex flex-col gap-2">
        <div className="flex flex-col gap-2 p-3 rounded-md bg-lightBg-tertiary dark:bg-darkBg-tertiary">
          ...
          <div className="flex flex-col">
            <Input
              placeholder="Nome Técnico (ex: cepTool)"
              value={formData.name}
          ...
          <div className="flex flex-col">
            <textarea
              ...
              className="w-full mt-1 h-24 p-2 rounded-md resize-y bg-lightBg-primary dark:bg-darkBg-primary text-lightFg-primary dark:text-darkFg-primary"
              disabled={loading}
              maxLength="256"
            />
        ...
        <div className="p-3 rounded-md bg-lightBg-tertiary dark:bg-darkBg-tertiary">
          ...
          <div className="flex gap-2 mt-1">
            <select
              ...
              className="rounded-full bg-lightBg-primary dark:bg-darkBg-primary text-lightFg-primary dark:text-darkFg-primary p-2"
              disabled={loading}>
          ...
          <div className="flex flex-col gap-2 mt-2">
            <div>
              ...
              <textarea
                ...
                className="w-full h-40 p-2 mt-1 rounded-md resize-y font-mono text-xs bg-lightBg-primary dark:bg-darkBg-primary text-lightFg-primary dark:text-darkFg-primary"
              />
            </div>
            <div>
