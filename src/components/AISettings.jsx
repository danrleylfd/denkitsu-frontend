...
const AISettings = ({ isOpen, onClose, freeModels, payModels, groqModels, clearHistory }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="relative flex w-full max-w-md flex-col gap-2 rounded-lg bg-lightBg-primary dark:bg-darkBg-primary p-4 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="custom-prompt" className="text-lightFg-secondary dark:text-darkFg-secondary">Como Denkitsu deve se comportar?</label>
          <textarea
            id="custom-prompt"
            value={customPrompt}
