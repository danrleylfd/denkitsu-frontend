...
const AIProvider = ({ children }) => {
  ...
  const values = useMemo(() => ({
    ...
    setBrowserTool, toggleBrowser,
    setDuckduckgoTool, toggleDuckduckgo,
    setHttpTool, toggleHttp,
    setWikiTool, toggleWiki,
    setNewsTool, toggleNews,
    setWeatherTool, toggleWeather,
    setCriptoTool, toggleCripto,
    setCinemaTool, toggleCinema,
    setGamesTool, toggleGames,
    setAlbionTool, toggleAlbion,
    setGenshinTool, toggleGenshin,
    setPokedexTool, togglePokedex,
    setNasaTool, toggleNasa,
