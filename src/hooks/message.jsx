...
const useMessage = (props) => {
  ...
  const executeSendMessage = useCallback(async (historyToProcess, agentForCall) => {
            ...
            setMessages(prevMessages =>
              prevMessages.map(msg => {
                if (msg.id === placeholderId) {
                  ...
                  if (delta.tool_calls) { /* ... lógica de tool_calls ... */ }
                  return updatedMsg
                }
                return msg
              })
    ...
    setMessages, notifyError, signed, loadUser, customProviderUrl
  ])

  // ... (o resto do arquivo onSendMessage, handleSendAudioMessage, etc., permanece o mesmo, pois eles chamam o novo executeSendMessage simplificado)
