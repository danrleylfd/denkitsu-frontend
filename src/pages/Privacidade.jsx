...
### Deepseek, Gemini e Qwen
Os prompts do usuário são compartilhados com o Deepseek, Gemini ou Qwen para gerar respostas. Esses serviços podem ter suas próprias políticas de privacidade, que recomendamos que você consulte.

### Terceiros
Denkitsu não compartilha suas informações com terceiros além do Deepseek, Gemini ou Qwen, conforme especificado nesta política. Em nenhuma hipótese seus dados pessoais serão vendidos ou alugados.

## Armazenamento e Segurança de Dados

### Processamento Local
As informações da página atual e os prompts do usuário são processados localmente no seu navegador. Denkitsu não transmite ou armazena seus dados em seus servidores.

### Segurança
Denkitsu toma medidas razoáveis para proteger as informações processadas localmente contra acesso não autorizado, uso indevido ou alteração. No entanto, como o processamento é feito no seu dispositivo, a segurança dos seus dados também depende das suas práticas de segurança pessoal.
...
Se você tiver alguma dúvida sobre esta Política de Privacidade, entre em contato em:

danrley.reply+dev@gmail.com
`
