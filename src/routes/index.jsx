...
const AppRoutes = () => {
  ...
  const mainClassMap = {
    ...
    "/cinema": "flex-1 p-4 rounded-lg shadow-lg w-full max-w-[95%] max-h-[95%] mx-auto overflow-y-auto bg-lightBg-primary dark:bg-darkBg-primary opacity-80 dark:opacity-90",
